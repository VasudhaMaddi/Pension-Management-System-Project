...
public class PensionDisbursementServiceTests {
	...
	ProcessPensionInput processPensionInput2 = new ProcessPensionInput(12345678910120L, 60.0, 55.0);
	...
	public void processPensionTestSuccess() throws Exception {
		assertEquals(21, pensionDisbursementServiceDao.processPension(token, processPensionInput));
