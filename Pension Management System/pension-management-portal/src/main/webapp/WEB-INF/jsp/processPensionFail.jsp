...
<body>
	...
	<div class="container">
				...
				<br>
				<form method="get" action="/processPensionForm" class="center"><button
						class="btn btn-success mt-4 col-sm-6 btn-lg button">Try Again</button></form>
				
				
			
			<form method="get" action="/pensionerDetailForm" class="center"><button
						class="btn btn-success mt-4 col-sm-6 btn-lg button">Calculate
						Again</button></form>
